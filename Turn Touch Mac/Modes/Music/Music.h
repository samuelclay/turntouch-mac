...
- (MusicAppTrack *) searchFor:(NSString *)for_ only:(MusicESrA)only;  // search a playlist for tracks matching the search string. Identical to entering search text in the Search field.
...
@interface MusicAppTrack : MusicItem
...
@interface MusicAudioCDTrack : MusicAppTrack
...
@interface MusicFileTrack : MusicAppTrack
...
@interface MusicSharedTrack : MusicAppTrack


@end

// a track representing a network stream
@interface MusicURLTrack : MusicAppTrack
