...
- (void)viewDidLoad {
    ...
    NSInteger volumeJump = [[self.action optionValue:kSpotifyVolumeJump inDirection:self.appDelegate.modeMap.inspectingModeDirection] integerValue];
...
- (IBAction)slideVolume:(id)sender {
    [self.action changeActionOption:kSpotifyVolumeJump to:[NSNumber numberWithInteger:self.volumeSlider.integerValue]];
