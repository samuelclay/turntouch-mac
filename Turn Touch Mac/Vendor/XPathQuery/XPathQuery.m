...
NSArray *PerformXPathQuery(xmlDocPtr doc, NSString *query, char *ns, char *xmlNs)
{
    ...
    xmlXPathRegisterNs(xpathCtx, (xmlChar *)ns, (xmlChar *)xmlNs);
...
NSArray *PerformHTMLXPathQuery(NSData *document, NSString *query, char *ns, char *xmlNs)
{
	...
	NSArray *result = PerformXPathQuery(doc, query, ns, xmlNs);
    xmlFreeDoc(doc); 
