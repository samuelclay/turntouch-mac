...
- (QuicktimeDocument *) newMovieRecording;  // Create a new movie recording document.
- (QuicktimeDocument *) newAudioRecording;  // Create a new audio recording document.
- (QuicktimeDocument *) newScreenRecording;  // Create a new screen recording document.
